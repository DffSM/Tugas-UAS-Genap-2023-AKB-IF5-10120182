...
public final class FragmentNoteBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView mynote;

  private FragmentNoteBinding(@NonNull CoordinatorLayout rootView,
      @NonNull FloatingActionButton buttonAdd, @NonNull RecyclerView mynote) {
  ...
  public static FragmentNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.mynote;
      RecyclerView mynote = ViewBindings.findChildViewById(rootView, id);
      if (mynote == null) {
        break missingId;
      }

      return new FragmentNoteBinding((CoordinatorLayout) rootView, buttonAdd, mynote);
    }
